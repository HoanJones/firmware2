...
if "%option%" == "clean" (
	...
	gnumake -f Makefile TOP_DIR=" %CURDIR%\" DFLAG+="-D%project_macro% -D%project_macro_BT% -D%project_macro_GNSS% -D%project_macro_CUS% -D%project_macro_FS_OLD% -D%project_macro_OVERSEASGNSS% -D%project_macro_TLS13%"
)
