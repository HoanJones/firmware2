...
CPPFLAGS:=-c -MMD -mlong-calls -march=armv7-r  -mcpu=cortex-r4  -mlittle-endian -mthumb -mthumb-interwork  -mfloat-abi=soft -Wall -ffunction-sections -fdata-sections $(FNO_BUILTIN_FLAGS) -std=c++1z -g -Os
ARFLAG:=-rc
